...
const PCOSForm = ({ onClose }) => {
  ...
  const validateCurrentPage = () => {
    switch (currentPage) {
      case 1:
        return formData.age !== "" && formData.menstrualCycle !== "";
      case 2:
        return true;
      case 3:
        return true;
  ...
  const calculateRiskPrediction = () => {
    ...
    if (formData.menstrualCycle === "Irregular") {
      riskScore += 5;
      riskFactors.push("Irregular menstrual cycles");
    } else if (formData.menstrualCycle === "Absent") {
      riskScore += 8;
      riskFactors.push("Absent menstrual cycles (Amenorrhea)");
    }

    // Physical symptoms
    if (formData.acne) {
      riskScore += 3;
      riskFactors.push("Persistent acne");
    }
    if (formData.hirsutism) {
      riskScore += 4;
      riskFactors.push("Hirsutism (excessive body hair)");
    }
    if (formData.weightGain) {
      riskScore += 2;
      riskFactors.push("Unexplained weight gain");
    }
    if (formData.thinningHair) {
      riskScore += 3;
      riskFactors.push("Scalp hair thinning");
    }
    if (formData.fatigue) {
      riskScore += 1;
    ...
    // Medical history
    if (formData.ovarianCysts) {
      riskScore += 6;
      riskFactors.push("History of ovarian cysts");
    }
    if (formData.insulinResistance) {
      riskScore += 7;
      riskFactors.push("Insulin resistance/prediabetes");
    }
    ...
    if (riskScore <= 10) {
      ...
      riskColor = "yellow";
      recommendations = [
        "Your symptoms are consistent with some PCOS indicators.",
        "Consider consultation with a gynecologist or endocrinologist.",
      ...
      riskColor = "red";
      recommendations = [
        "Based on your symptoms, there is a higher probability of PCOS.",
        "It is strongly recommended you seek medical evaluation immediately.",
      ...
      <div className="fixed inset-0 bg-black/70 backdrop-blur-md flex items-center justify-center p-4 z-50">
        <div className="bg-white rounded-3xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
          ...
          <div className="bg-gradient-to-r from-rose-500 via-pink-500 to-red-500 text-white p-6 sm:p-8 rounded-t-3xl relative overflow-hidden">
            ...
            <p className="text-rose-100 text-base sm:text-lg">Your personalized PCOS risk analysis is ready.</p>
          </div>
        ...
        <div className="sticky top-0 bg-white/95 backdrop-blur-md border-b-2 border-rose-200 p-4 sm:p-6 z-10">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-xl sm:text-2xl font-bold text-gray-900">PCOS Risk Assessment</h1>
            ...
            <div className="space-y-8">
              ...
              {currentPage === 1 && (
                <div className="space-y-8 animate-in slide-in-from-right duration-500">
                  <FormSection title="General & Menstrual History" icon={User} gradient="from-rose-500 to-pink-600">
                    <FormField
                      label="Age"
                      name="age"
                      type="number"
                    ...
                    <FormField
                      ...
                      onChange={handleChange}
                      description="Mother, sister, or close relatives with PCOS"
                    />
                    <div className="lg:col-span-2 space-y-6">
                      <FormField
                        ...
                        description="How would you describe your menstrual cycles?"
                      />
                    </div>
                  </FormSection>
                </div>
              ...
              {currentPage === 2 && (
                <div className="space-y-8 animate-in slide-in-from-right duration-500">
                  <FormSection title="Physical Symptoms" icon={Heart} gradient="from-pink-500 to-rose-600">
                    <FormField
                      ...
                      value={formData.acne}
                      onChange={handleChange}
                      description="Severe or persistent acne, especially on face, chest, or back"
                    />
                    <FormField
                      label="Excess Body Hair (Hirsutism)"
                      name="hirsutism"
                      type="checkbox"
                      value={formData.hirsutism}
                      onChange={handleChange}
                      description="Excessive hair growth on face, chest, abdomen, or back"
                    />
                    <FormField
                      ...
                      onChange={handleChange}
                      description="Significant weight gain, especially around the abdomen"
                    />
                    <FormField
                      ...
                      onChange={handleChange}
                      description="Noticeable thinning of hair on the scalp"
                    />
                  </FormSection>
                </div>
              )}
                ...
                <div className="space-y-8 animate-in slide-in-from-right duration-500">
                  <FormSection title="Medical History" icon={Shield} gradient="from-rose-500 to-pink-600">
                    <FormField
                      ...
                      onChange={handleChange}
                      description="Previously diagnosed with ovarian cysts via ultrasound"
                    />
                    <FormField
                      label="Insulin Resistance/Prediabetes"
                      name="insulinResistance"
                      type="checkbox"
                      value={formData.insulinResistance}
                      onChange={handleChange}
                      description="Diagnosis of insulin resistance, Type 2 diabetes, or prediabetes"
                    />
                    <div className="lg:col-span-2">
                      <FormField
                        ...
                        onChange={handleChange}
                        description="Persistent and unexplained low energy levels"
                      />
                    </div>
                  </FormSection>
                </div>
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl p-8 shadow-2xl max-w-xl text-center border-2 border-rose-200">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-4">
          Welcome to the PCOS Risk Assessment
        </h1>
        <p className="text-gray-600 text-lg mb-8">
          This tool helps you evaluate your potential risk of Polycystic Ovary Syndrome (PCOS) based on your symptoms and medical history.
        </p>
        <button
